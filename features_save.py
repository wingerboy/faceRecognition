...
path_faces_rd = "D:/data_faces_from_camera/"
path_csv = "D:/data_csvs_from_camera/"
...
facerec = dlib.face_recognition_model_v1("D:/test/dlib_face_recognition_resnet_model_v1.dat")
...
# 存放所有特征均值的 CSV 的路径
path_csv_feature_all = "D:/features_all/features_all.csv"

# 存放人脸特征的 CSV 的路径
path_csv_rd = "D:/data_csvs_from_camera/"
